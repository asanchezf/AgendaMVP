...
import com.antonio.agendamvp2.util.ImportarContactos;
...
public class MainMvpModel implements MvpModel{
    ...
    @Override
    public void importarContactosModelo(Context context, ArrayList<Contactos> contactos) {
    ...
    public MainMvpModel abrirBaseDeDatos(int opcion) throws SQLException {
