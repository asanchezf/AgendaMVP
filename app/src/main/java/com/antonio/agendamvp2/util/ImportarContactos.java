package com.antonio.agendamvp2.util;
...
public class ImportarContactos {
    ...
    private MainMvpModel Connection;
    ...
    public ImportarContactos(Context contexto, ArrayList<Contactos> contactosMain) {
    ...
    public void importar(){
		/*
		* Trae todos los contactos de la agenda de Android y los inserta en la BB.DD. de la app.
...
////==============================================================================================================
        ...
        Connection = new MainMvpModel(micontexto);//Objeto SQLControlador
        try {
